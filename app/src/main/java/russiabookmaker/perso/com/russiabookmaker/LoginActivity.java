...
import russiabookmaker.perso.com.russiabookmaker.rest.LoginService;
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Call<User> call =
                        loginService.callLogin(mLoginView.getText().toString(), mPasswordView.getText().toString());
                ...
                call.enqueue(new Callback<User>() {
                    ...
                    public void onResponse(Call<User> call, Response<User> response) {
                        ...
                        if (user.isLoggedIn()) {
                            ...
                            editor.putString(getString(R.string.login), mLoginView.getText().toString());
                            editor.commit();
                            startActivity(intent);
                            showProgress(false);
                            finish();
